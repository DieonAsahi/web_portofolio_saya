  ...
  return (
    <div className="container project-container">
      ...
      <div className="project-content">
        ...
        <p>
          Dalam proyek ini, saya berperan sebagai Machine Learning Engineer
          dengan tanggung jawab utama dalam melatih model untuk mengenali
          berbagai jenis sampah, seperti organik, anorganik, dan daur ulang.
          Sistem ini dikembangkan menggunakan Python untuk proses machine
          learning dan diintegrasikan dengan Flask sebagai backend, serta
          antarmuka berbasis HTML dan CSS.
        </p>

        <div className="image-scroll-wrapper">
          <div className="image-scroll">
            <img src="/images/pemilah_1.png" alt="Produk Ecommerce" />
            <img src="/images/pemilah_2.png" alt="Produk Ecommerce" />
            <img src="/images/pemilah_3.png" alt="Produk Ecommerce" />

            {/* DUPLIKAT (biar loop smooth) */}
            <img src="/images/pemilah_1.png" alt="Produk Ecommerce" />
            <img src="/images/pemilah_2.png" alt="Produk Ecommerce" />
            <img src="/images/pemilah3.png" alt="Produk Ecommerce" />
          </div>
        </div>
